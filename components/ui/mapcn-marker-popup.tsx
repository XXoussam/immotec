...
>({
  ...
  useEffect(() => {
    ...
    const handleClusterClick = async (
      ...
      const pointCount = (feature.properties?.point_count ?? 0) as number;
    ...
    const handlePointClick = (
      ...
      if (!e.features?.[0]) return;
      const feature = e.features[0] as unknown as GeoJSON.Feature<GeoJSON.Point, P>;
    ...
    map.on("mouseenter", unclusteredLayerId, setCursorPointer);
    map.on("mouseleave", unclusteredLayerId, resetCursor);
    ...
    return () => {
      ...
      map.off("mouseenter", unclusteredLayerId, setCursorPointer);
      map.off("mouseleave", unclusteredLayerId, resetCursor);
    };
